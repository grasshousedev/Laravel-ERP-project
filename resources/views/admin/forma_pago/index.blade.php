...
@section('content_header')
    <a class="btn btn-primary float-right" href="{{ route('admin.formapago.create') }}" role="button">Agregar forma de pago</a>
    <h1>Forma de pago</h1>
@stop
            ...
            <table class="table table-striped" id="estado_entrega">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="10px">
                            <a href="{{ route('admin.formapago.edit', $forma->id) }}" class="btn btn-sm btn-primary">
                        ...
                        <td width="10px">
                            ...
                            <form action="{{ route('admin.formapago.destroy', $forma->id) }}" method="POST">
